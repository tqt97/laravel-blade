        ...
        <section class="rounded-2xl border border-border bg-card p-6 shadow-sm sm:p-8">
            ...
            @if ($clientSecret)
                <button type="button" data-stripe-confirm aria-busy="false"
                    class="mt-6 inline-flex w-full items-center justify-center rounded-xl bg-primary px-4 py-3 text-sm font-semibold text-primary-foreground transition hover:bg-primary/90">
