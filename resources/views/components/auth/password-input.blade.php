...
<div>
    <div class="mb-2 flex items-center justify-between gap-3">
        ...
        @elseif ($generate)
        <button type="button" data-password-generate="{{ $name }}" class="text-xs font-semibold text-neutral-600 transition hover:text-neutral-700 dark:text-neutral-300 dark:hover:text-neutral-200">{{ __('ui.password.generate') }}</button>
        @endif
    </div>
    <div class="relative">
        ...
        <button type="button" data-password-toggle="{{ $name }}" data-password-show="{{ __('ui.password.show') }}" data-password-hide="{{ __('ui.password.hide') }}" aria-pressed="false" title="{{ __('ui.password.show') }}" class="absolute inset-y-0 right-0 flex w-12 items-center justify-center text-neutral-400 transition hover:text-neutral-600 dark:text-neutral-500 dark:hover:text-neutral-300">
