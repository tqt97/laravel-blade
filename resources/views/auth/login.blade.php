<x-layouts.guest title="Đăng nhập">
    <div class="mb-8">
        ...
        <p class="mt-3 text-sm leading-6 text-neutral-500 dark:text-neutral-400">
            Nhập thông tin của bạn để tiếp tục đến không gian làm việc.
        </p>
    </div>
    ...
    <form method="POST" action="{{ route('login.store') }}" class="space-y-5">
        ...
        <x-auth.password-input label="Mật khẩu" name="password" action-text="Quên mật khẩu?"
        ...
        <x-admin.button type="submit" icon="arrow-right" class="w-full">Đăng nhập</x-admin.button>
    </form>
    ...
    <p class="mt-8 text-center text-sm text-neutral-500 dark:text-neutral-400">Chưa có tài khoản?
