                ...
                <tbody class="divide-y divide-border">@forelse ($bookings as $booking)
                    <tr>
                        ...
                        <td class="whitespace-nowrap px-5 py-4 text-right">
                            ...
                            @endif
                            @if ($booking->payment?->status?->isRefundable())
                            ...
                            @endif
                            @if (! $booking->status->occupiesResource() && ! $booking->payment?->status?->isRefundable())<span class="text-xs text-muted-foreground">—</span>@endif
                        </td>
                </tr>@empty<tr>
