...
return [
    'users' => [
        'messages' => [
            ...
            'restored' => 'Đã khôi phục người dùng thành công.',
            'bulk_restored' => 'Đã khôi phục thành công :count người dùng.',
            'force_deleted' => 'Đã xóa vĩnh viễn người dùng.',
            'bulk_force_deleted' => 'Đã xóa vĩnh viễn :count người dùng.',
        ],
        'errors' => [
            ...
            'restore_email_conflict' => 'Không thể khôi phục người dùng vì email đã được sử dụng. Hãy xử lý email trùng và thử lại.',
        ],
    ],
];
