...
return [
    ...
    'payment' => [
        ...
        'reconciliation_fast_window_minutes' => 5,
        'reconciliation_deadline_minutes' => 30,
        'reconciliation_fast_retry_seconds' => 30,
        'reconciliation_normal_retry_seconds' => 300,
        'reconciliation_late_retry_seconds' => 900,
        'refund_idempotency_key_prefix' => env('BOOKING_PAYMENT_REFUND_IDEMPOTENCY_KEY_PREFIX', 'booking-refund-'),
        'refund_webhook_attempt_key_prefix' => env('BOOKING_PAYMENT_REFUND_WEBHOOK_ATTEMPT_KEY_PREFIX', 'stripe-webhook-refund-'),
        'refund_reconciliation_max_attempts' => (int) env('BOOKING_PAYMENT_REFUND_RECONCILIATION_MAX_ATTEMPTS', 20),
        'refund_reconciliation_retry_minutes' => (int) env('BOOKING_PAYMENT_REFUND_RECONCILIATION_RETRY_MINUTES', 5),
