...
return [
    ...
    'payment' => ['currency' => env('BOOKING_CURRENCY', 'USD'), 'amount_minor_units' => (int) env('BOOKING_AMOUNT_MINOR_UNITS', 0), 'provider' => env('BOOKING_PAYMENT_PROVIDER', env('STRIPE_SECRET') ? 'stripe' : 'fake')],
    'operating_hours' => [
